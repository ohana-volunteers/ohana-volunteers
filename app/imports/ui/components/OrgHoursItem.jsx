...
/** Renders a single row in the List Hours (Organization) table. See pages/ListHours.jsx. */
const OrgHoursItem = ({ Hours }) => (
  <Table.Row>
    ...
    <Table.Cell>{Hours.isVerified}</Table.Cell>
    <Table.Cell>
...
export default withRouter(OrgHoursItem);
