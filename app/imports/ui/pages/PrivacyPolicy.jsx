  ...
  <Grid id={PAGE_IDS.PRIVACY_POLICY} container>
    ...
    <Grid.Row>
      <Container>
        ...
        <p>Like most website operators, Volunteer Ally collects non-personally-identifying information of the sort that web browsers and servers typically make available, such as the browser type, language preference, referring site, and the date and time of each visitor request.Volunteer Ally’s purpose in collecting non-personally identifying information is to better understand how Volunteer Ally’s visitors use its website. From time to time, Volunteer Ally may release non-personally-identifying information in the aggregate, e.g., by publishing a report on trends in the usage of its website.</p>
        <p>Volunteer Ally also collects potentially personally-identifying information like Internet Protocol (IP) addresses for logged in users and for users leaving comments on https://volunteerally.org blog posts. Volunteer Ally only discloses logged in user and commenter IP addresses under the same circumstances that it uses and discloses personally-identifying information as described below.</p>

        <Header as='h1'>Gathering of Personally-Identifying Information</Header>
        <p>Certain visitors to Volunteer Ally’s websites choose to interact with Volunteer Ally in ways that require Volunteer Ally to gather personally-identifying information. The amount and type of information that Volunteer Ally gathers depends on the nature of the interaction. For example, we ask visitors who sign up for a blog at https://volunteerally.org to provide a username and email address.</p>
        ...
        <p>Ads appearing on our website may be delivered to users by advertising partners, who may set cookies. These cookies allow the ad server to recognize your computer each time they send you an online advertisement to compile information about you or others who use your computer. This information allows ad networks to, among other things, deliver targeted advertisements that they believe will be of most interest to you. This Privacy Policy covers the use of cookies by Volunteer Ally and does not cover the use of cookies by any advertisers.</p>
